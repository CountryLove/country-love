...
router
    ...
    //don't put "get" in route path, already part of HTTP METHOD
    .get('/countrysTags', (req, res, next) => {
        Experience.getCountrysTags(req.query.country)
            .then( data => {
                res.send(data);
            })
            .catch(next);
    ...
    .get('/countriesByTag', (req, res, next) => {
        Experience.getCountriesByTag(req.query.tag)
            .then( data => {
                res.send(data);
            })
            .catch(next);
